...
seed = 100
discretization_bounds = 5000 
log_dir = "logs/mujoco/Hopper_state_discretization_new_"+str(discretization_bounds)+'_'+str(seed)+ "/"
...
model.learn(total_timesteps=1000000,use_action_repeat= False,poisson=False,skip_q_curriculum=False,state_space_discretization = True,discretization_bounds =discretization_bounds, callback=callback)
f.close()
