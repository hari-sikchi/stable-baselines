...
log_dir = "logs/mujoco/Hopper_anneal_norm/"
...
env = DummyVecEnv([lambda: gym.make("HopperEnvRep-v0")])
...
def callback(_locals, _globals):
    ...
    global n_steps, best_mean_reward,env
    ...
    #     f.write("Steps: {} 100 Episode eval: {}".format(n_steps,mean_reward))
